#!/usr/bin/env python3
"""
SVG Workshop Advanced GUI

Wallpaper generator using SVG patterns with sidebar layout.
"""
...
class WorkshopGUI:
    ...
    def __init__(self):
        ...
        self.svg_size_var = ctk.IntVar(value=96)
    ...
    def setup_scrollable_sidebar(self):
        ...
        self.sidebar = self.sidebar_scroll
    ...
    def enable_mouse_wheel_scrolling(self):
        ...
        self.root.bind("<Button-4>", on_mouse_wheel_linux_up)
        self.root.bind("<Button-5>", on_mouse_wheel_linux_down)
    ...
    def setup_svg_section(self):
        """Set up SVG path display."""
        try:
    ...
    def setup_advanced_settings(self):
        ...
        svg_size_label = ctk.CTkLabel(settings_frame, text="Size:", font=label_font)
        ...
        self.svg_size_value_label = ctk.CTkLabel(settings_frame, text="96", font=value_font)
        self.svg_size_value_label.grid(row=2, column=2, padx=5, pady=5)
    ...
    def create_pattern_previews(self):
        """Create preview thumbnails for each pattern."""
        for pattern in Pattern:
            try:
                preview_config = {
                    "svg_path": self.selected_svg,
                    "svg_size": 28,
                    "img_size": (270, 170),
                    "grid": (7, 5),
                    "pattern": pattern,
                    ...
                    "margin": 3,
                    "output_filename": f"preview_{pattern.pattern_name}_{id(self)}.png"
                }
    ...
    def update_background(self):
        ...
        try:
            ...
            config = {
                "svg_path": self.selected_svg,
                "svg_size": max(32, int(self.svg_size_var.get() * preview_scale)),
                ...
                "svg_count": min(100, max(20, int(self.count_var.get() * 0.5))),
    ...
    def generate_wallpaper(self):
        ...
        config = {
            "svg_path": self.selected_svg,
            "svg_size": int(self.svg_size_var.get()),
            "img_size": (width, height),
            "grid": (10, 12),
            "pattern": self.selected_pattern,
            "scale_variation": self.scale_var.get(),
            "svg_count": int(self.count_var.get()),
            "color": self.selected_color,
            "margin": 10,
